...
- (WKWebView *)createNewWebView {
    ...
    // WebView equivalent for UIWebView's scalesPageToFit
    // http://stackoverflow.com/questions/26295277/webview-equivalent-for-uiwebviews-scalespagetofit
    ...
    [UController addUserScript:UScript];
...
+ (NSBundle *)frameworkBundle {
    ...
    dispatch_once(&predicate, ^{
        NSString* mainBundlePath = [[NSBundle bundleForClass:[YTPlayerView class]] resourcePath];
